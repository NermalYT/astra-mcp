...
Reopen the platform installer, choose **Install addon…**, select the extracted addon folder and confirm after reviewing its manifest. Restart Astra to activate it. See [the setup guide](SETUP.md). Uploading a submission is a separate, explicit action in the [community addon area](../addons/README.md).
