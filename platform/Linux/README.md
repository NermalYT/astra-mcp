...
1. Extract the entire `Astra-<version>-Linux-Ubuntu-LTS.tar.gz` archive.
...
4. Restart LM Studio, choose a model with working tool calling, and enable **mcp/astra**. Ask the model to call `astra_status`.
