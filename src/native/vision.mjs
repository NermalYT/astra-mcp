...
const VISION_HOME = path.join(process.env.ASTRA_DATA_DIR || path.join(HOME, '.local/share/astra-mcp'), 'vision');
...
function captureDesktop({ region = null, maxWidth = 1536, quality = 82, showCursor = true }) {
    const tempDir = mkdtempSync(path.join(os.tmpdir(), "astra-shot-"));
...
function imageResult(
    ...
    const metadata = {
        ...
        coordinate_space: "astra_private_desktop",
