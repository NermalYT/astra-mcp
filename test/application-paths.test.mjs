...
test('application discovery keeps host XDG precedence and Flatpak/Snap exports', () => {
  ...
  const dirs = applicationDirectories({ home, env: { ASTRA_HOST_DATA_HOME: custom, XDG_DATA_HOME: path.resolve('private-data'), XDG_DATA_DIRS: '/opt/xdg:/usr/share:/opt/xdg:relative' }, exists: () => true });
