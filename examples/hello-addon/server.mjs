...
const handle = request => {
  ...
  if (method === 'initialize') return respond({ id, result: { protocolVersion: ['2024-11-05', '2025-03-26', '2025-06-18', '2025-11-25'].includes(params.protocolVersion) ? params.protocolVersion : '2025-11-25', capabilities: { tools: {} }, serverInfo: { name: 'hello-astra-addon', version: '1.0.0' } } });
  ...
  if (method === 'tools/call') {
    ...
    return respond({ id, result: { content: [{ type: 'text', text: `Hello, ${args.name}! Your private Astra addon is working.` }] } });
  }
